...
<header>
        ...
        <nav class="nav-bar">
            <ul>
                ...
                <li><a href="deliverymyord.php" >Available orders</a></li>
...
?>
    <style>
        ...
        <div class="itm" >
            ...
            <img src="../img/deliverydonate.jpg" alt="" width="400" height="400"> 
...
<a href="deliverymyord.php">Available Orders</a>
...
?>
            ...
            <td data-label="Action" style="margin:auto">
                ...
                <?php } else if ($row['delivery_by'] == $id) { ?>
                    Order available are as follows
                <?php } else { ?>
                    Order not available at this location
                <?php } ?>
            </td>
        </tr>
        <?php } ?>
